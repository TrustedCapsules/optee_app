...
#define POLICY_TIME_MAX					12 //Maximum value for a itoa(long double) string
...
typedef enum
{
	...
	ERROR_UNKNOWN_WHERE = 		POLICY_ERROR_UNKNOWN_WHERE,
	...
	ERROR_VAL_BAD_SIZE = 		POLICY_ERROR_VAL_BAD_SIZE,
